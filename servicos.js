...
const ctx = document.getElementById('dataChart').getContext('2d');
            ...
            const infoTexts = {
                sensors: {
                    ...
                    short: "Nossos sensores aquáticos de última geração medem constantemente parâmetros cruciais como temperatura, salinidade, pH e níveis de oxigênio dissolvido.",
